...
const invoker_1 = __nccwpck_require__(811);
const core = __nccwpck_require__(186);
const meta = __nccwpck_require__(598);
...
program
    ...
    .option('-t, --token <token>', 'Personal Access Token or GITHUB_TOKEN (or comma separated tokens)', core.getInput('token'))
    .option('-e, --enterprise <slug>', 'Enterprise slug', core.getInput('enterprise'))
    .option('-cd, --config_directory <config_directory>', 'Path to directory containing configuration files (e.g. rule file)', core.getInput('config_directory'))
    .option('-ex, --exceptions_directory <exceptions_directory>', 'Path to directory containing rule exceptions', core.getInput('exceptions_directory'))
    .option('-rr, --reporting_repository <owner/repo>', 'Optional - Repository specified as Owner/Repo for final report', core.getInput('reporting_repository'))
    .option('-o, --organization <organization_login>', 'Optional - Limit to specified organization login only', core.getInput('organization'))
    .option('-rd, --report_directory <path>', 'Optional - Specifies the location to write the json report to (defaults to current directory)', '.')
    .parse();
(() => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const options = program.opts();
        const invoker = new invoker_1.Invoker(options);
        const result = yield invoker.executeCommand(options);
...
const dummy_command_1 = __nccwpck_require__(916);
exports.commands = [dummy_command_1.DummyCommand];
...
const commands_1 = __nccwpck_require__(976);
...
class Invoker {
     ...
     */
    loadCommands() {
        core.debug(`Loading commands from ${commands_1.commands.length} files`);
        commands_1.commands.reduce((accumulator, command) => {
    ...
    executeCommand(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var commandName = typeof options.command === typeof ''
                ? options.command
                : options.command();
            ...
            return yield command.execute(options);
        });
    }
}
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(504);
